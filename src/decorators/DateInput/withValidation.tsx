...
type BaseInputType = typeof BaseDateInput;

export const withValidation = (Component: BaseInputType) => {
  const Wrapper: BaseInputType = forwardRef<HTMLInputElement, DateInputProps>(({ onDateSelect, ...rest }, ref) => {
